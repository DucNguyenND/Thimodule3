...
public class StaffDao {
    ...
    private static final String SEACH_BYNAME_SQL="select * from thimodule3.Staff join thimodule3.Department on thimodule3.Staff.idDepartment=thimodule3.Department.idDepartment WHERE namestaff LIKE %?% ";
    ...
    public List<Staff> serch(String name){
        try (Connection connection = connect_mySQL.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(SEACH_BYNAME_SQL);
        ) {
